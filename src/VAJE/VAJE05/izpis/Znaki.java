...
public class Znaki {
    ...
    private static int vrniIndeksZnaka(char znak) {
    ...
    public static void izpisi16bit(String niz) {
        ...
        for (int i = 0; i < niz.length(); i++) {
            nizZnakov[i] = kodeZnakov16bit[vrniIndeksZnaka(niz.charAt(i))];
        }
    ...
    public static void izpisi64bit(String niz) {
        ...
        for (int i = 0; i < niz.length(); i++) {
            nizZnakov[i] = kodeZnakov64bit[vrniIndeksZnaka(niz.charAt(i))];
        }
